...
import { Button, CardActionArea, CardActions, Container, CssBaseline, Divider, Grid, IconButton, Rating } from '@mui/material';
    ...
    {products.length > 0 ?
        <Grid container spacing={2} sx={{marginTop:"20px",}}>
            {products.map((product:productType) =>   
                ...
                <Grid item xs={6} sm={6} md={4} lg={3} xl={3} key={product._id} sx={{marginLeft:-0.6,marginRight:0.5}}>
                <Card sx={{height:{xs:390,sm:470,md:460}, width: {xs:183,sm:215,md:230,lg:290},
                ...
                >
                    <CardActionArea >
                        ...
                        image={product.image}
                        alt={product.title}
                        sx={{objectFit:"contain",aspectRatio:"3/2",height:{xs:150,sm:200}}}
                        />
                        <Divider sx={{width:"100vw",position:"absolute",left:-10,right:0}}/>
                        
                        
                        <CardContent>
                        
                        <Typography  color={"black"} sx={{fontSize:{xs:"1rem",md:"1.2rem",},fontWeight:"bold",}}>
                            {product.title}
                        </Typography>
                        <Typography gutterBottom color={"text.secondary"} 
                            sx={{fontSize:{xs:"0.8rem",md:"1rem"},fontWeight:{xs:"bold",md:"normal"}}}
                        >
                            {product.description}
                        </Typography>
                        <Typography  color="text.primary" paddingRight={1} sx={{fontWeight:"bold",fontSize:"1.2rem"}}>
                        ...
                        <div style={{display:"flex", justifyContent:"flex-start"}}>
                            ...
                            <Typography variant="body2" color="green" sx={{fontWeight:"bold",fontSize:"0.9rem"}}>
