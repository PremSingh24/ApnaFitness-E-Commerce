    ...
    >
      <Grid container spacing={1} sx={{position:"relative"}}>
        ...
        <NavLink to={`/products/${cart.item._id}`}>
          <ButtonBase sx={{ width: {xs:128,sm:150}, height: {xs:128,sm:150} }}>
        ...
        <Grid item xs={7} sm container >
          <Grid item xs container direction="column" spacing={2}>
            ...
            <Grid item sx={{display:"flex",flexDirection:"row",justifyContent:"space-between",}}>
                ...
                <Typography  color={"black"} variant='body1' sx={{display:"flex",
                  justifyContent:"space-between",alignItems:"center",
                  fontWeight:"bold",border:"1px solid gray",
                  width:"90px",borderRadius:"10px"}}
                >
                    
                    <IconButton
                    onClick={()=>{updateCart(cart._id,cart.quantity-1)}}
                    disabled = {cart.quantity === 1 ? true:false}
                    sx={{borderRight:"1px solid gray",borderRadius:"1px",width:"30px",color:"black"}}
                    >
                        <RemoveIcon />
                    </IconButton>
                    ...
                    sx={{borderLeft:"1px solid gray",borderRadius:"1px",width:"30px",color:"black"}}
                    >
                        <AddIcon/>
                    </IconButton>
                </Typography>
