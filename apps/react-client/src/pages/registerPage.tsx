  ...
  const setLogin = useLoginStore((state)=>state.setLogin)
        ...
        if(data.password !== data.confirmPassword){
          toast.error("Passwords Don't Match");
            ...
            if(data.email === ""){
              ...
              response = await registerUserService({firstName,lastName,mobile,password});
    ...
    return (
      <ThemeProvider theme={defaultTheme}>
        ...
        <Container  component="main" maxWidth="xs" sx={{marginTop:{xs:"8rem",md:"6rem"}}}>
        <CssBaseline />
          ...
          <Box component="form" noValidate onSubmit={handleSubmit(registerUser)} sx={{ mt: 2 }}>
            <Grid container spacing={2}>
              <Grid item xs={12} sm={6}>
                <TextField
                    ...
                    fullWidth
                    required
                    {...register("firstName",{required:"First Name is Required",minLength:{value:2,message:"Minumum 2 Characters"},
                    pattern: {
                        value: /^\S*$/,
              ...
              <Grid item xs={12} sm={6}>
                <TextField
                    ...
                    fullWidth
                    required
                    {...register("lastName",{required:"Last Name is Required",minLength:{value:2,message:"Minumum 2 Characters"},
                    pattern: {
                        value: /^\S*$/,
                        message: "Space Detected",
                    }})}
              ...
              <Grid item xs={12}>
                <TextField
                    ...
                    minLength:{value:10,message:"There are less than 10 digits"},
                    pattern: {
