...
import { Button, Card, CardActions, CardContent, CardMedia, Container, Divider, Grid, IconButton, Rating, Stack, Toolbar, Typography } from "@mui/material";
...
const SingleProductPage = () =>{
    ...
    return (
        ...
        <Toolbar/>
            <Grid container sx={{marginTop:"20px",display:"flex",justifyContent:"center",flexDirection:"row"}}>

            <Card sx={{maxHeight:710, maxWidth: 945,padding:"10px",marginBottom:"20px", 
            position:"relative",display:"flex",justifyContent:"center",flexDirection:"row" }} >
                ...
                <Card sx={{maxHeight:710, maxWidth: 945,padding:"10px",marginBottom:"20px",display:"flex",justifyContent:"start",flexDirection:"row" }}>
                ...
                <CardContent>
                    ...
                    <div style={{display:"flex", justifyContent:"flex-start",flexDirection:"row",marginTop:"20px"}}>
                        <Typography variant="h5"  color="text.primary" paddingRight={1}>
                            ₹{product.currentPrice}   
                        </Typography>
                        <Typography variant="body2" color="text.secondary" fontSize={"1.2rem"} paddingRight={1} style={{textDecoration:"line-through"}}>
                    ...
                    <CardActions sx={{display:"flex", flexDirection:"column",marginTop:"30px",justifyContent:"center"}}>
                    {product.inStock?
